...
import com.mohammad.twitterbackend.dto.mapper.UserDtoMapper;
...
import com.mohammad.twitterbackend.util.UserUtil;
...
//        userDto.setFollowed(UserUtil.isReqUser(reqUser, user)); twitter-spring-boot-backend
        userDto.setFollowed(UserUtil.isFollowedByReqUser(reqUser, user));
